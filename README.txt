...
a persistence unit "Prueba1PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "Prueba1/pom.xml":
...
artifact ("Prueba1.war") is already built. You can build
